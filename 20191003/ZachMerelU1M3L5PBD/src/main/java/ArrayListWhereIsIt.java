...
//            for (int i = 0; i <findTheInt.size() ; i++) {
//                if (i == userNumber) {
//                    System.out.println(userNumber + " is in slot " + i);
//                }
//            }
            for (Integer x : findTheInt) {
                if (x == userNumber) {
                    indexNumber = findTheInt.lastIndexOf(x);
                }
            }
            System.out.println(userNumber + " is in slot " + indexNumber);
        } else {
