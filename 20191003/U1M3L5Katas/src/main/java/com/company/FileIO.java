...
public class FileIO {
    ...
    static void writeTelevisions(List<Television> motorcycles, String filename) throws IOException, CsvDataTypeMismatchException, CsvRequiredFieldEmptyException {
