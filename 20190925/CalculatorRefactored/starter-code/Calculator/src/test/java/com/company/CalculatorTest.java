...
public class CalculatorTest {
    ...
    @Test
    public void shouldReturnSumOfTwoLongs() {

        String failMessage = "Expected calculator to handle long addition.";
    ...
    @Test
    public void shouldReturnSumOfTwoFloats() {

        String failMessage = "Expected calculator to handle float addition.";
    ...
    @Test
    public void shouldReturnDifferenceOfTwoLongs() {

        String failMessage = "Expected calculator to handle long subtraction.";
    ...
    @Test
    public void shouldReturnProductOfTwoLongs() {

        String failMessage = "Expected calculator to handle long multiplication.";
    ...
    @Test
    public void shouldReturnProductOfTwoFloats() {

        String failMessage = "Expected calculator to handle float multiplication.";
    ...
    @Test
    public void shouldReturnQuotientOfTwoLongs() {
    ...
    @Test
    public void shouldReturnQuotientOfTwoFloats() {

        String failMessage = "Expected calculator to handle float division.";
