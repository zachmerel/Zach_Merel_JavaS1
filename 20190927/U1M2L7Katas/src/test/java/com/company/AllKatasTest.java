...
public class AllKatasTest {
    ...
    @Test
    public void shouldInheritFromCarAndSedanClassesWhenRun() {
    ...
    @Test
    public void shouldReturnExpectedClassWhenGetterIsCalled() throws Exception {
        ...
        failMessage = "Expected getTransmission to return a Transmission class";
        assertTrue(failMessage, accord.getTransmission() instanceof Transmission);
    }

    @Test
    public void shouldReturnExpectedMethodWhenCalled() throws Exception {
